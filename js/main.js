$(function(){
    ...
    function m_reset() {
        ...
        $("#publisher .img .img_box").removeClass("recycle")
        $("#publisher .big_f .main li").removeClass("on")
        $("#publisher .folder_number p").html("empty")
        $("#publisher .img .img_box").css({
            left:"0"
        })
        $("#publisher .img .p1").css({
            left:"5%",
            top:"15%"
        })
        $("#publisher .img .p2").css({
            left:"110%",
            top:"15%"
        })
        $("#publisher .img .p3").css({
            left:"215%",
            top:"15%"
        })
        $("#publisher .img .p4").css({
            left:"5%",
            top:"25%"
        })
        $("#publisher .img .p5").css({
            left:"110%",
            top:"25%"
        })
        $("#publisher .img .p6").css({
            left:"215%",
            top:"25%"
        })
        $("#publisher .img .p7").css({
            left:"5%",
            top:"35%"
        })
        $("#publisher .img .p8").css({
            left:"110%",
            top:"35%"
        })
        $("#publisher .img .p9").css({
            left:"215%",
            top:"35%"
        })
        $("#publisher .img .p10").css({
            left:"5%",
            top:"45%"
        })
        $("#publisher .img .p11").css({
            left:"110%",
            top:"45%"
        })
        $("#publisher .img .p12").css({
            left:"215%",
            top:"45%"
        })
        $("#publisher .img .p13").css({
            left:"5%",
            top:"55%"
        })
        $("#publisher .img .p14").css({
            left:"110%",
            top:"55%"
        })
        $("#publisher .img .p15").css({
            left:"215%",
            top:"55%"
        })
        $("#publisher .img .p16").css({
            left:"5%",
            top:"65%"
        })
        $("#publisher .img .p17").css({
            left:"110%",
            top:"65%"
        })
        $("#publisher .img .p18").css({
            left:"215%",
            top:"65%"
        })
        $("#publisher .img .p19").css({
            left:"5%",
            top:"75%"
        })
        $("#publisher .img .p20").css({
            left:"110%",
            top:"75%"
        })
    }
    ...
    $("#publisher .img .img_box .box img").hover(function(){
        if(mobile==true){
            $("#publisher .img .img_box").css({
                zIndex:0
            })
    ...
    $("#publisher .img .box").click(function(){
        if(mobile==true){
            ...
            if($(this).hasClass("p10")){
                window.open("./publisher/10/index.html")
            }
            if($(this).hasClass("p11")){
                window.open("./publisher/11/RADEON.html")
            }
            if($(this).hasClass("p12")){
                window.open("./publisher/12/index.html")
            }
            if($(this).hasClass("p13")){
                window.open("./publisher/13/한국닌텐도.html")
            }
            if($(this).hasClass("p14")){
                window.open("./publisher/14/index.html")
            }
            if($(this).hasClass("p15")){
                window.open("./publisher/15/index.html")
            }
            if($(this).hasClass("p16")){
                window.open("./publisher/16/pulmuone.html")
            }
            if($(this).hasClass("p17")){
                window.open("./publisher/17/index.html")
            }
            if($(this).hasClass("p18")){
                window.open("./publisher/18/index.html")
            }
            if($(this).hasClass("p19")){
                window.open("./publisher/19/hollys.html")
            }
        ...
        if(wheel==false){
            $("#cursor .c1").delay(5).queue(function(next1){
                ...
                $("#cursor .c2").delay(15).queue(function(next2){
                    ...
                    $("#cursor .c3").delay(15).queue(function(next3){
                        $(this).css({
                            top:$("#cursor .c2").offset().top+1,
                            left:$("#cursor .c2").offset().left+1
                        })
